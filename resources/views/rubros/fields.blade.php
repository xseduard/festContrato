...
<!-- Codigo Field -->
<div class="form-group col-sm-6 has-feedback{{ $errors->has('codigo') ? ' has-error' : '' }}">
    {!! Form::label('codigo', 'Codigo') !!}
    {!! Form::text('codigo', null, ['class' => 'form-control']) !!}
</div>

<!-- Valor Field -->
<div class="form-group col-sm-6 has-feedback{{ $errors->has('valor') ? ' has-error' : '' }}">
    {!! Form::label('valor', 'Valor') !!}
    {!! Form::text('valor', null, ['class' => 'form-control']) !!}
</div>

<!-- Fecha Vigencia Inicio campo de fecha -->
<div class="form-group col-sm-6 has-feedback{{ $errors->has('fecha_vigencia_inicio') ? ' has-error' : '' }}">
...
<div class="form-group col-sm-6 has-feedback{{ $errors->has('fecha_vigencia_final') ? ' has-error' : '' }}">
