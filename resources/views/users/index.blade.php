...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary btn-flat pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('usuarios.create') !!}"><i class="fa fa-plus"></i> &nbsp; Aregar</a>
        </h1>
    </section>
    <div class="content">
        ...
        <div class="animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">            
            @if($users->isEmpty())
                <div class="alert alert-info alert-dismissible">
                   ...
                   No se encontraron registros de Users en esta consulta.
                </div>                    
            @else
