...
@section('content')
    <section class="content-header">
        <h1>
            Obligación especifica <small><i class="fa fa-angle-right" aria-hidden="true"></i></small> Editar
        </h1>
   </section>
   <div class="content">
       ...
       <div class="animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
         <div class="box box-primary">
             <div class="box-body">
                 <div class="row">
                     {!! Form::model($obligacion, ['route' => ['obligacions.update', $obligacion->id], 'method' => 'patch']) !!}

                          @include('obligacions.fields')
