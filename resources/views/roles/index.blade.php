...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary btn-flat pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('roles.create') !!}"><i class="fa fa-plus"></i> &nbsp; Aregar</a>
        </h1>
    </section>
    <div class="content">
        ...
        <div class="animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">            
            @if($roles->isEmpty())
                <div class="alert alert-info alert-dismissible">
                   ...
                   No se encontraron registros de Roles en esta consulta.
                </div>                    
            @else
